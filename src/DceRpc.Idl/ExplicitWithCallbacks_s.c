...
static const RPC_SERVER_INTERFACE ExplicitWithCallbacks___RpcServerInterface =
    {
...
RPC_IF_HANDLE ExplicitWithCallbacks_v0_1_s_ifspec = (RPC_IF_HANDLE)& ExplicitWithCallbacks___RpcServerInterface;

extern const MIDL_STUB_DESC ExplicitWithCallbacks_StubDesc;

 extern const MIDL_STUBLESS_PROXY_INFO ExplicitWithCallbacks_ProxyInfo;
    ...
    /* [string][in] */ wchar_t *szOutput)
{
    ...
    NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &ExplicitWithCallbacks__MIDL_ProcFormatString.Format[68],
...
static const MIDL_STUB_DESC ExplicitWithCallbacks_StubDesc = 
    {
    (void *)& ExplicitWithCallbacks___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const SERVER_ROUTINE ExplicitWithCallbacks_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)AsyncAttach,
    (SERVER_ROUTINE)Request,
    };
...
static const MIDL_SERVER_INFO ExplicitWithCallbacks_ServerInfo = 
    ...
    ExplicitWithCallbacks_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
